<template>
  ...
  <div class="absolute -top-10 left-1/2 h-16 w-16 -translate-x-1/2 rounded-xl border-4 border-sky-500 bg-white p-2"><img class="h-full object-contain" src="https://png.pngtree.com/png-clipart/20200727/original/pngtree-circle-letter-r-logo-design-png-image_5070013.jpg" alt="" /></div>
